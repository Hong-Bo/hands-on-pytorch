"""An implementation of VGGNet11 to classify CIFAR-10 dataset
...
of VGGNet11 has smaller kernel sizes and stride paces in one way and the fully
...
class Classifier(object):
    ...
    def __init__(self, data_dir, model_dir='../data/vgg11.pth', log_interval=50,
        ...
        self.model = VGGNet11(10).to(self.device)
